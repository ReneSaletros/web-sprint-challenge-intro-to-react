...
React is a virtual DOM. It is a comparison of what the DOM looked like before and after a state changes. It uses a diffing algorithm to determine which DOM nodes to update inside the browser. This speeds up load times and prevents the entire website from reloading every time a user input happens.

1. Describe component state.
It's where you store values that belong to that component.

1. Describe props.
Short for properties and is used to pass data from one component to another, from parent to child flow.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are anything that affects something outside the scope of function being executed. To sync you pass in a dependency array as the second argument to the effect hook.
